...
public class SearchSpecificTreatment {
    ...
    public List<TreatmentFake> runDbQueryBySearchProcedureID(String newProcedureID) {
       
       String query=
               "select Provider.name,Procedures.Description,Treatment.AveragePayments,Provider.StreetAddress "
    ...
    public List<TreatmentFake> runDbQueryBySearchProcedureName(String newProcedureName) {
