                  ...
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <div class="slidecontainer">
                        ...
                        <input type="range" class="custom-range" name="rangeInput" min="1" max="1000000" onchange="updateTextInput(this.value);">
                      ...
                      <div class="slidecontainer2">
                        ...
                        <input type="range" class="custom-range "name="rangeInput" min="0" max="2000" onchange="updateTextInput2(this.value);">
